...
export const GET_PRODUCT_BY_ARRIVAL = 'get_products_by_arrival';
export const GET_PRODUCT_BY_SELL = 'get_products_by_sell';
...
export const CLEAR_UPDATE_USER_DATA = 'clear_udpate_user_data';
